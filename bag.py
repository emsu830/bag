...
if __name__ == '__main__':
    #Simple tests
    b = Bag(['d','a','b','d','c','b','d'])
    print("b ('Bag' object) = " + str(b) + '\n')
    
    print('String Representation of b: ' + repr(b))
    print('Total # of Items in b: ' + str(len(b)))
    print('# of Unique Items in b: ' + str(b.unique()))
    print("b contains 'a': " + str('a' in b))
    print("b contains 'z': " + str('z' in b))
    print("# of times 'd' is in b: " + str(b.count('d')) + '\n')
    
    b2 = Bag(['a','a','b','x','d'])
    print("b2 ('Bag' object) = " + str(b2))
    print('Union of b + b2 = ' + str(b + b2) + '\n')
    
    b2.remove('x')
    print("Remove 'x' from b2 = " + str(b2))
